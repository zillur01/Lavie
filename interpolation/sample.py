    ...
    for seed in args.seed_list:
        ...
        for ckpt in [ckpt_path]:
            ...
            for input_path in args.input_path_list:
                ...
                video_file = args.input_path.split('/')[-1].split('.mp4')[0]
                with open(os.path.join(args.prompt_folder,video_file,".txt"), 'r') as f:
                ...
                for idx, prompt in enumerate(class_name):
                    ...
                    for fps in args.fps_list:
                        ...
                        local_save_path = os.path.join(save_path, f'{video_file}.mp4')
